-- Promocja prospekta przenosi dane kontaktowe z raw_data na leada (e-mail/telefon/osoba),
-- żeby znaleziony przez szukacza adres był od razu dostępny do outreachu.
...
begin
  ...
  insert into public.partner_leads (firma_nazwa, nip, osoba_kontakt, email, telefon, status, assigned_to, source, prospect_id)
  values (
